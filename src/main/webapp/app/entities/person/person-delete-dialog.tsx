...
export const PersonDeleteDialog = (props: IPersonDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.person.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.person.delete.question" interpolate={{ id: personEntity.id }}>
