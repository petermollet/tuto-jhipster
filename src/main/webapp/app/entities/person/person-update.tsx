...
export const PersonUpdate = (props: IPersonUpdateProps) => {
  ...
  const { personEntity, addresses, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.person.home.createOrEditLabel" data-cy="PersonCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.person.home.createOrEditLabel">Create or edit a Person</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : personEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="person-birthday" data-cy="birthday" type="date" className="form-control" name="birthday" />
              </AvGroup>
              <AvGroup>
                <Label for="person-address">
                  <Translate contentKey="jhipsterSampleApplicationApp.person.address">Address</Translate>
                </Label>
                <AvInput id="person-address" data-cy="address" type="select" className="form-control" name="addressId">
                  <option value="" key="0" />
                  {addresses
