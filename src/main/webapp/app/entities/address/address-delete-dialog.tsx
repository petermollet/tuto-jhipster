...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.address.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
