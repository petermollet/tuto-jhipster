...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().number(DEFAULT_NUMBER).road(DEFAULT_ROAD).zipCode(DEFAULT_ZIP_CODE).town(DEFAULT_TOWN);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().number(UPDATED_NUMBER).road(UPDATED_ROAD).zipCode(UPDATED_ZIP_CODE).town(UPDATED_TOWN);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.number(UPDATED_NUMBER).road(UPDATED_ROAD).zipCode(UPDATED_ZIP_CODE).town(UPDATED_TOWN);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.number(UPDATED_NUMBER).zipCode(UPDATED_ZIP_CODE).town(UPDATED_TOWN);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.number(UPDATED_NUMBER).road(UPDATED_ROAD).zipCode(UPDATED_ZIP_CODE).town(UPDATED_TOWN);
